	...
	<div class="row">
        <div class="col-xs-12">
			<ol class="breadcrumb">
				...
				<li class="active"> Data Berita Acara Pemeriksaan Dan Penerima Barang</li>
			</ol>
		</div>
	</div>
</section>
...
<section class="content">
  <div class="row">
    ...
    elseif ($_GET['alert'] == 1) {
      echo "<a href='main.php?page=bappb'><div class='alert alert-success alert-dismissable'>
    ...
    ?>
	  ...
	  <div class="box-header with-border">
	  	<div class="col-xs-12">
		<h2>
			<i class="fa fa-list icon-title"></i> Data Berita Acara Pemeriksaan Dan Penerima Barang
			<a class="btn btn-primary btn-sm pull-right" href="main.php?page=bappb&act=tambah">
				<i class="fa fa-plus"></i> Tambah Berita Acara Pemeriksaan Dan Penerima Barang
			</a>
		</h2>
		</div>
