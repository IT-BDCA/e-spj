	...
	<div class="row">
        <div class="col-xs-12">
			<ol class="breadcrumb">
				...
				<li class="active"> Data Jenis Surat</li>
			</ol>
		</div>
	</div>
</section>
  ...
  <div class="row">
    ...
    ?>
	  ...
	  <div class="box-header with-border">
	  	<div class="col-xs-12">
		<h2>
			<i class="fa fa-list icon-title"></i> Data Jenis Surat
			<a class="btn btn-primary btn-sm pull-right" href="main.php?page=jnsfasilitas&act=tambah">
			<i class="fa fa-plus"></i> Tambah Data Jenis Surat
			</a>
		</h2>
		</div>
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            <thead>
              <tr>
				...
				<th class="left" width='50%'>Link</th>
			...
			if($data['st_jnsfasilitas'] == 'N'){
            ?>
                          <a data-toggle="tooltip" data-placement="top" title="Aktif Kan" class="btn btn-warning btn-sm" href="data/jnsfasilitas/proses.php?act=aktif&id=<?php echo $data['id_jnsfasilitas'];?>" onclick="return confirm('Apakah anda akan mengaktifkan kategori <?php echo $data['nm_jnsfasilitas']; ?> ?');">
			<i style="color:#fff" class="fa fa-thumbs-o-up"></i> Aktif
                          </a>
            <?php
			}else{ 
			?>
                          <a data-toggle="tooltip" data-placement="top" title="Non Aktif Kan" class="btn btn-danger btn-sm" href="data/jnsfasilitas/proses.php?act=nonaktif&id=<?php echo $data['id_jnsfasilitas'];?>" onclick="return confirm('Apakah anda akan menonaktifkan kategori <?php echo $data['nm_jnsfasilitas']; ?> ?');">
