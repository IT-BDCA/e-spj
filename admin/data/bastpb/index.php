	...
	<div class="row">
        <div class="col-xs-12">
			<ol class="breadcrumb">
				...
				<li class="active"> Data Berita Acara Serah Terima Dan Penerimaan Barang</li>
			</ol>
		</div>
	</div>
</section>
  ...
  <div class="row">
    ...
    ?>
	  ...
	  <div class="box-header with-border">
	  	<div class="col-xs-12">
		<h2>
			<i class="fa fa-list icon-title"></i> Data Berita Acara Serah Terima Dan Penerimaan Barang
			<a class="btn btn-primary btn-sm pull-right" href="main.php?page=bastpb&act=tambah">
				<i class="fa fa-plus"></i> Tambah Berita Acara Serah Terima Dan Penerimaan Barang
			</a>
		</h2>
		</div>
