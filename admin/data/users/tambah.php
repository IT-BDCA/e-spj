	...
	<div class="row">
        <div class="col-xs-12">
			<ol class="breadcrumb">
				...
				<li class="active"> Tambah Data Users</li>
			</ol>
		</div>
	</div>
</section>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
			...
			<div class="col-xs-12">
			<h2>
				<i class="fa fa-list icon-title"></i>  Tambah Data Users
			</h2>
			</div>

			</div>
			<!-- form start -->
			  <form class="form-horizontal" action="data/users/proses.php?act=insert" method="post">
				<div class="box-body">
					<div class="col-xs-12">
				...
				<div class="box-footer">
				  ...
				  <div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
					  ...
					  <a href="main.php?page=users" class="btn btn-default btn-reset">Batal</a>
					</div>
				  </div>
				  </div>
				</div><!-- /.box footer -->
